...
3️⃣ **ODINAMENTO**  
- Trascina le azioni (drag & drop) nell’ordine desiderato (disponibile solo in modalità di modifica);
- L’ordine numerico si aggiorna automaticamente;
- Le ricette nella schermata home si salvano automanticamente in ordine alfabetico (a --> z).
